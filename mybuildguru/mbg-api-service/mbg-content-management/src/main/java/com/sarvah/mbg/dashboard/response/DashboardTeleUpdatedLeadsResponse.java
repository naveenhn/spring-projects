 ...
 *
 */
public class DashboardTeleUpdatedLeadsResponse {
	private String teleAssociateName;
	...
	/**
	 * @return the teleAssociateName
	 */
	public String getTeleAssociateName() {
		return teleAssociateName;
	}

	/**
	 * @param teleAssociateName
	 *            the teleAssociateName to set
	 */
	public void setTeleAssociateName(String teleAssociateName) {
		this.teleAssociateName = teleAssociateName;
	}
